/*
  ==============================================================================
   ...
   ==============================================================================
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   This class is a straight up copy of the private JUCE class OSCInputStream.
   !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!
   ==============================================================================
*/


#ifndef SYNCOSC_JUCE_OSC_INPUT_STREAM_H
#define SYNCOSC_JUCE_OSC_INPUT_STREAM_H
...
#endif //SYNCOSC_JUCE_OSC_INPUT_STREAM_H
