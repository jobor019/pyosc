...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 156.0, 138.0, 178.0, 22.0 ],
									"text" : "TODO: Not working as intended"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 100.5, 463.0, 46.0, 46.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "", "" ],
									"patching_rect" : [ 41.0, 395.0, 138.0, 22.0 ],
...
, 							{
								"patchline" : 								{
									...
									"midpoints" : [ 110.0, 446.0, 350.25, 446.0, 350.25, 206.0, 253.5, 206.0 ],
									"order" : 0,
									"source" : [ "obj-2", 1 ]
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 596.0, 333.5, 190.0, 37.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 1068.0, 176.0, 184.0, 51.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 1202.0, 711.0, 125.0, 62.0 ],
									"text" : "file:/Users/joakimborg/MaxProjects/pyosc/pyosc/misc/python-interpreters.json"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 896.0, 412.0, 74.0, 26.0 ],
									"text" : "demo.py",
									"textcolor" : [ 1.0, 0.709803921568627, 0.196078431372549, 1.0 ]
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 896.0, 190.0, 170.0, 24.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 896.0, 234.0, 77.0, 22.0 ],
									"text" : "absolutepath"
								}
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 413.0, 655.5, 112.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 413.0, 618.5, 89.0, 22.0 ],
									"text" : "route uncaught"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 48.0, 659.0, 90.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 48.0, 622.0, 55.0, 22.0 ],
									"text" : "route id0"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 111.0, 528.0, 59.0, 22.0 ],
									"text" : "terminate"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 48.0, 528.0, 51.0, 22.0 ],
									"text" : "initialize"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "" ],
									"patching_rect" : [ 48.0, 580.0, 384.0, 22.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 452.0, 565.5, 184.0, 51.0 ],
...
, 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 557.0, 414.0, 112.0, 22.0 ],
									"text" : "print trace @level 2"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 2,
									"outlettype" : [ "", "" ],
									"patching_rect" : [ 557.0, 377.0, 89.0, 22.0 ],
									"text" : "route uncaught"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 3,
									"outlettype" : [ "", "int", "" ],
									"patching_rect" : [ 41.0, 341.0, 535.0, 22.0 ],
									"text" : "pyosc.agent demo.py 5678 8765 @autoinitialize 0 @interpreter filepath:/opt/homebrew/bin/python3"
								}
...
,
						...
						"boxes" : [ 							{
								"box" : 								{
									...
									"numinlets" : 1,
									"numoutlets" : 0,
									"patching_rect" : [ 872.0, 603.0, 119.0, 33.0 ],
									"text" : "(This is just random ASCII gibberish)"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 507.0, 603.0, 363.0, 35.0 ],
									"text" : "mmt}M@0fikwe3uU3G8pr]ZwH3a&Ev=R<L6+T\\,(aZn\\;yJ*@]/xp]NW\\,l]&7X\\;oCwz\\\"e!Roorr46K/d(oUd^uwn!T7ew<PpWO>1>j"
								}
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 39.0, 603.0, 459.0, 62.0 ],
...
, 							{
								"box" : 								{
									...
									"numoutlets" : 1,
									"outlettype" : [ "" ],
									"patching_rect" : [ 578.0, 599.0, 175.0, 102.0 ],
									"text" : "/opt/homebrew/Caskroom/miniconda/base/bin/python3 /Users/joakimborg/MaxProjects/pyosc/pyosc/help/fatal.py --recv_port 2347 --send_port 7432 --ip 127.0.0.1 --log_level 0 2>&1"
								}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "" ],
									"patching_rect" : [ 1367.0, 712.0, 125.0, 49.0 ],
									"text" : "file:/Users/joakimborg/MaxProjects/pyosc/pyosc/help/demo.py"
								}
