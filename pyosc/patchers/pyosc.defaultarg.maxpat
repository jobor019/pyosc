...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 94.0, 150.0, 100.0 ],
					"text" : "abstraction to parse a named argument to a default value if not provided.\n\nUseful for multi-level nested abstractions"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 345.0, 54.0, 248.0, 20.0 ],
					"text" : "(for documentation only: uses #1 / #2 syntax)"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 345.0, 30.0, 191.0, 22.0 ],
					"text" : "patcherargs argname defaultvalue"
				}
...
,
					"patching_rect" : [ 127.0, 103.0, 160.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 30.0, 152.0, 184.0, 22.0 ],
					"text" : "#2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 4,
					"outlettype" : [ "", "", "", "" ],
					"patching_rect" : [ 30.0, 65.0, 123.0, 22.0 ],
					"text" : "route 0 auto #1"
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 136.5, 138.0, 39.5, 138.0 ],
					"source" : [ "obj-31", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-5", 0 ],
					"midpoints" : [ 277.5, 183.5, 39.5, 183.5 ],
					"source" : [ "obj-31", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 108.833333333333329, 104.5, 39.5, 104.5 ],
					"source" : [ "obj-35", 2 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 74.166666666666657, 104.5, 39.5, 104.5 ],
					"source" : [ "obj-35", 1 ]
				}
