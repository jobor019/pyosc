...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 326.0, 444.0, 221.0, 47.0 ],
					"text" : "if initialization failed (passing \"fail\" on second inlet), all further messages will arrive on the second outlet"
				}

			}
, 			{
				"box" : 				{
					"comment" : "(any) messages if initialization failed",
					"id" : "obj-7",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 287.0, 444.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 475.0, 101.0, 51.0, 22.0 ],
					"text" : "t 3 clear"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 108.0, 400.0, 77.0, 22.0 ],
					"text" : "route symbol"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 587.0, 33.0, 150.0, 275.0 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 211.5, 283.0, 73.0, 74.0 ],
...
, 			{
				"box" : 				{
					"comment" : "(any) messages through",
					"id" : "obj-15",
					"index" : 0,
					"maxclass" : "outlet",
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 108.0, 448.0, 30.0, 30.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 302.5, 71.0, 249.0, 22.0 ],
					"text" : "sel bang done reinit fail"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 3,
					"outlettype" : [ "", "", "" ],
					"patching_rect" : [ 108.0, 217.0, 198.0, 22.0 ],
					"text" : "gate 3 1"
				}
...
, 			{
				"box" : 				{
					"comment" : "(any) incoming messages to await patcherargs",
					"id" : "obj-1",
					"index" : 0,
					"maxclass" : "inlet",
					"numinlets" : 0,
		...
		"lines" : [ 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 1 ],
					"midpoints" : [ 117.5, 169.0, 296.5, 169.0 ],
					"source" : [ "obj-1", 0 ]
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 207.0, 439.0, 117.5, 439.0 ],
					"source" : [ "obj-2", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-15", 0 ],
					"midpoints" : [ 175.5, 438.5, 117.5, 438.5 ],
					"source" : [ "obj-4", 1 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-2", 0 ],
					"midpoints" : [ 484.5, 202.5, 117.5, 202.5 ],
					"source" : [ "obj-6", 0 ]
				}
...
, 			{
				"patchline" : 				{
					"destination" : [ "obj-9", 0 ],
					"midpoints" : [ 516.5, 360.5, 117.5, 360.5 ],
					"source" : [ "obj-6", 1 ]
				}
